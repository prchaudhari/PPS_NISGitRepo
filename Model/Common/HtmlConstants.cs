...
namespace nIS
{
    public class HtmlConstants
    {
        ...
        public const string CUSTOMER_DETAILS_WIDGET_HTML = "<div class='card border-0'><div class='card-body CustomerDetails pb-1 pt-1'>{{Title}} {{FirstName}} {{Surname}} <br>{{CustAddressLine0}} <br>{{CustAddressLine1}}<br>{{CustAddressLine2}} <br>{{CustAddressLine3}}<br>{{CustAddressLine4}}<br></div></div>";

        public const string BANK_DETAILS_WIDGET_HTML = "<div class='card border-0'><div class='card-body BankDetails pb-1 pt-1'>{{BankName}}<br>{{AddressLine1}}<br>{{AddressLine2}}<br>{{CountryName}}<br>{{BankVATRegNo}}</div><div class='ConactCenterDiv text-success float-right pt-3'>{{ContactCenter}}</div></div>";

        public const string INVESTOR_PERFORMANCE_WIDGET_HTML = "<div class='card border-0'><div class='card-body text-left pb-1 pt-1'><div class='card-body-header pb-2'>Investor performance</div><div class='InvestmentPermanaceDiv'><table class='InvestorPermanaceTable' border='0' id='InvestorPerformance'><tbody><tr><td class='w-50' colspan='2'><span class='text-success fnt-10pt'>{{ProductType}}</span></td></tr><tr><td class='w-50 fnt-8pt pt-1'>Opening balance</td><td class='w-50 fnt-8pt'>Closing balance</td></tr><tr><td class='w-50 fnt-14pt'>{{OpeningBalanceAmount}}</td><td class='w-50 fnt-14pt'>{{ClosingBalanceAmount}}</td></tr></tbody></table></div></div></div>";

        public const string INVESTMENT_PORTFOLIO_STATEMENT_WIDGET_HTML = "<div class='card border-0'><div class='card-body text-left pb-1 pt-1'><div class='card-body-header pb-2'>Investment portfolio statement {{DSName}} </div><div class='row pb-1'><div class='col-lg-4 pr-1'><div class='TotalAmountDetailsDiv'><span class='fnt-10pt'>Current investor balance</span><br><span class='fnt-14pt'>{{TotalClosingBalance}}</span>&nbsp;<br></div></div><div class='col-lg-8 pl-0'><div class='TotalAmountDetailsDiv'></div></div></div><div class='pt-1 pb-2' style='background-color:#f3f3f3'><table class='customTable mt-2' border='0' id='portfolio'><tbody class='fnt-8'><tr><td class='w-25'>Account type:</td><td class='w-25 text-right pr-4 text-success'>Investment</td><td class='w-25'>Statement Day:</td><td class='w-25 text-right text-success'>{{DayOfStatement}}</td></tr><tr><td class='w-25'>Investor no:</td><td class='w-25 text-right pr-4 text-success'>{{InvestorID}}</td><td class='w-25'>Statement Period:</td><td class='w-25 text-right text-success'>{{StatementPeriod}}</td></tr><tr><td class='w-25'>Statement date:</td><td class='w-25 text-right pr-4 text-success'>{{StatementDate}}</td></tr></tbody></table></div></div></div>";

        public const string BREAKDOWN_OF_INVESTMENT_ACCOUNTS_WIDGET_HTML = "<div class='card border-0'><div class='card-body text-left pb-1 pt-1'><div class='card-body-header pb-2'>Breakdown of your investment accounts</div>{{NavTab}} {{TabContentsDiv}} </div></div>";

        public const string INVESTMENT_ACCOUNT_DETAILS_HTML = "<div id='{{ProductDesc}}-{{InvestmentId}}' class='{{TabPaneClass}}'><div style='background-color: #f3f3f3;padding:5px 0px'><h4 class='pl-25px'><span class='InvestmentProdDesc'>{{ProductDesc}}</span></h4><table border='0' class='InvestmentDetail customTable'><tbody><tr><td class='w-25'>Investment no:</td><td class='text-right w-25'><span>{{InvestmentNo}}</span></td><td class='w-25'>Opening date:</td><td class='text-right w-25'><span>{{AccountOpenDate}}</span></td></tr><tr><td class='w-25'>Current interest rate:</td><td class='text-right w-25'><span>{{InterestRate}}</span></td><td class='w-25'>Maturity date:</td><td class='text-right w-25'><span>{{MaturityDate}}</span></td></tr><tr><td class='w-25'>Interest disposal:</td><td class='text-right w-25'><span>{{InterestDisposal}}</span></td><td class='w-25'>Notice period:</td><td class='text-right w-25'><span>{{NoticePeriod}}</span></td></tr><tr><td class='w-25'>Interest due:</td><td class='text-right w-25'><span>{{InterestDue}}</span></td><td class='w-25'>&nbsp;</td><td class='text-right w-25'>&nbsp;</td></tr></tbody></table><div class='InvestmentClosingBalanceDiv'><span class='fnt-8pt'>Balance at&nbsp;</span> <span class='text-success fnt-8pt'>{{LastTransactionDate}}</span><br><span class='text-success fnt-14pt'>{{BalanceOfLastTransactionDate}}</span></div></div> <div class='pt-1'><table class='InvestmentBreakdown customTable'><thead><tr class='ht-30'><th class='w-15'>Date</th><th class='w-40'>Description</th><th class='w-15 text-right'>Debit</th><th class='w-15 text-right'>Credit</th><th class='w-15 text-right'>Balance</th></tr></thead></table></div><div class='pt-0 overflow-auto' style='max-height:125px;'><table class='InvestmentBreakdown customTable'><tbody> {{InvestmentTransactionRows}} </tbody></table></div></div>";

        public const string EXPLANATORY_NOTES_WIDGET_HTML = "<div class='card border-0'><div class='card-body text-left pb-1 pt-1'><div class='card-body-header pb-2 fnt-10pt'>Explanatory notes</div><div class='ExplanatoryNotes'>{{Notes}}</div></div></div>";
