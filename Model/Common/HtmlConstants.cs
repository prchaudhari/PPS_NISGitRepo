...
namespace nIS
{
    public class HtmlConstants
    {
        ...
        public const string NEDBANK_STATEMENT_HEADER = "<div class='row'><div class='col-lg-6 col-sm-6' style='height:100px;'><div class='card border-0'><div class='card-body float-left pt-2 pb-2'><div class='eConfirm-logo-container'><img src='{{eConfirmLogo}}' alt='eConfirm Logo' height='80'><div class='eConfirm-logo-date'>{{StatementDate}}</div></div></div></div></div><div class='col-lg-6 col-sm-6' style='height:100px;'><div class='card border-0'><div class='card-body pt-2 pb-2'><a class='navbar-brand float-right mr-0' href='javascript:void(0);'> <img src='{{NedBankLogo}}' height='80'></a></div></div></div></div>";
        ...
        public const string CUSTOMER_DETAILS_WIDGET_HTML = "<div id={{WidgetId}} class='card border-0'><div class='card-body CustomerDetails pb-1 pt-1'>{{Title}} {{FirstName}} {{Surname}}<br>{{CustAddressLine0}}<br>{{CustAddressLine1}}<br>{{CustAddressLine2}}<br>{{CustAddressLine3}}<br>{{CustAddressLine4}}<br></div><div class='CustomerCellNoDiv'>{{MaskCellNo}}</div></div>";
