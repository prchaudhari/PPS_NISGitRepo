...
namespace nIS
{
    public class HtmlConstants
    {
        ...
        public const string EXPLANATORY_NOTES_WIDGET_HTML = "<div id={{WidgetId}} class='card border-0'><div class='card-body text-left pb-1 pt-1'><div class='card-body-header pb-2 fnt-10pt'>Explanatory notes</div><div class='ExplanatoryNotes'>{{Notes}}</div></div></div>";
