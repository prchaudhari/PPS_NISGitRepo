...
namespace nIS
{
    public class HtmlConstants
    {
        ...
        public const string NEDBANK_STATEMENT_FOOTER = "<div class='ftr'><div class='row'><div class='col-lg-4 col-sm-4'><img class='ftr-lt-span1' src='{{NedbankSloganImage}}' alt='Nedbank slogan' width='180'></div><div class='col-lg-8 col-sm-8'><img class='ftr-rt-span1' src='{{NedbankNameImage}}' alt='Nedbank Name' width='100'> <br/> <span class='ftr-rt-span2'>{{FooterText}}</span></div></div></div>";
