// <copyright file="TenantUser.cs" company="Websym Solutions Pvt. Ltd.">
    ...
    public class TenantUser
    {
        ...
        public void IsValid()
        {
            try
            {
                ...
                {
                    exception.Data.Add(this.utility.GetDescription("FirstName", typeof(TenantUser)), ModelConstant.USER_MODEL_SECTION + "~" + ModelConstant.INVALID_USER_NAME);
                }

                if (!this.validationEngine.IsValidText(this.LastName))
                {
                    exception.Data.Add(this.utility.GetDescription("LastName", typeof(TenantUser)), ModelConstant.USER_MODEL_SECTION + "~" + ModelConstant.INVALID_USER_NAME);
                }

                if (!this.validationEngine.IsValidText(this.EmailAddress))
                {
                    exception.Data.Add(this.utility.GetDescription("EmailAddress", typeof(TenantUser)), ModelConstant.USER_MODEL_SECTION + "~" + ModelConstant.INVALID_USER_EMAIL);
                }
