// <copyright file="TenantUserSearchParameter.cs" company="Websym Solutions Pvt Ltd">
...
namespace nIS
{
    ...
    /// </summary>
    public class TenantUserSearchParameter : BaseSearchEntity
    {
        ...
        /// </summary>
        [Description("TenantUser Identifier")]
        ...
        /// </summary>
        [Description("TenantUser Identifier To Skip")]
        public string TenantUserIdentifierToSkip
        {
            get
            {
        ...
        /// </summary>
        [Description("TenantUser First Name")]
        ...
        /// Get or sets the  value of user name
        /// </summary>
        [Description("TenantUser Last Name")]
        ...
        public void IsValid()
        {
            try
            {
                ...
                {
                    exception.Data.Add(this.utility.GetDescription("Paging parameter", typeof(TenantUser)), ModelConstant.COMMON_SECTION + "~" + ModelConstant.INVALID_PAGING_PARAMETER);
                }

                if (!this.SortParameter.IsValid())
                {
                    exception.Data.Add(this.utility.GetDescription("Sort parameter", typeof(TenantUser)), ModelConstant.COMMON_SECTION + "~" + ModelConstant.INVALID_SORT_PARAMETER);
                }
