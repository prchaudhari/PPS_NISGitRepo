...
import {
  CustomerInformationComponent, PPSFooter1Component, FSPDetailsComponent, PaymentSummaryComponent, PPSHeadingComponent, PPSDetailsComponent,
...
@NgModule({
  declarations: [AddDashboardDesignerComponent, PPSFooter1Component, PaymentSummaryComponent, PPSHeadingComponent, ViewDashboardDesignerComponent, CustomerInformationComponent, FSPDetailsComponent, PPSDetailsComponent,
  ...
  entryComponents: [
    CustomerInformationComponent, PPSFooter1Component, PPSDetailsComponent, FSPDetailsComponent, PaymentSummaryComponent, PPSHeadingComponent, AccountInformationComponent, ImageComponent, VideoComponent, SummaryAtGlanceComponent, TransactionDetailsComponent, SavingAvailableBalanceComponent,
