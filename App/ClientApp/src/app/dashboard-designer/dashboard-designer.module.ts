...
import {
  CustomerInformationComponent, PPSFooter1Component, FSPDetailsComponent, ProductSummaryComponent, PaymentSummaryComponent,
    FSPHeadingComponent,PPSDetails1Component,PPSDetails2Component, FooterImageComponent, DetailedTransactionsComponent,
...
@NgModule({
  declarations: [AddDashboardDesignerComponent, PPSFooter1Component, ProductSummaryComponent, PaymentSummaryComponent, FooterImageComponent, ViewDashboardDesignerComponent, CustomerInformationComponent, FSPDetailsComponent,
        AccountInformationComponent,PPSDetails1Component,PPSDetails2Component,ImageComponent, VideoComponent, SummaryAtGlanceComponent, TransactionDetailsComponent, FSPHeadingComponent, DetailedTransactionsComponent,
