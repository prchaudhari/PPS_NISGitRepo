...
import { DashboardReportService } from '../instancemanagerdashboard/dashboard.service';
...
@Component({
  selector: 'app-groupmanagerdashboard',
  templateUrl: './groupmanagerdashboard.component.html',
  styleUrls: ['./groupmanagerdashboard.component.scss']
})
export class GroupmanagerdashboardComponent implements OnInit {
