    ...
    public class ConfigurationUtility : IConfigurationUtility
    {
        ...
        public string GetConnectionString(string section, string configurationKey, string configurationBaseURLKey, string tenantKey, string tenantCode)
        {
            ...
            try
            {
                ...
                sqlConnectionString = @"metadata=res://*/NISDataContext.csdl|res://*/NISDataContext.ssdl|res://*/NISDataContext.msl;provider=System.Data.SqlClient;provider connection string="+ sqlConnectionString + "MultipleActiveResultSets=True;App=EntityFramework";
