...
namespace nIS
{
    ...
    /// <summary>
    /// This class represent api controller for page w
    /// </summary>
    public class PageController: ApiController
    {
        ...
        public string Preview(long pageIdentifier)
        {
            try
            {
                ...
                return this.pageManager.PreviewPage(pageIdentifier, baseURL, tenantCode);
            }
            catch (Exception exception)
            {
                throw exception;
        ...
        /// </returns>
        [HttpPost]
        public IList<Widget> GetStaticAndDynamicWidgets(long pageTypeId)
        {
            try
            {
                string tenantCode = Helper.CheckTenantCode(Request.Headers);
                return this.pageManager.GetStaticAndDynamicWidgets(pageTypeId, tenantCode);
            }
            catch (Exception ex)
            {
                throw ex;
