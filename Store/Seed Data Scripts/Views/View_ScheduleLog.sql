...
AS
SELECT sl.Id,sl.ScheduleName, sl.BatchId, sl.BatchName,
...
GROUP BY sl.ScheduleName, sl.BatchId, sl.BatchName, sl.CreationDate, sl.Status, srh.StartDate, srh.EndDate, sl.Id, sl.TenantCode