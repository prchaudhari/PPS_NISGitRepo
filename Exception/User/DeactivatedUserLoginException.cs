// <copyright file="DeactivatedUserLoginException.cs" company="Websym Solutions Pvt. Ltd.">
...
namespace nIS
{
    ...
    /// </summary>
    public class DeactivatedUserLoginException : Exception
    {
        ...
        public DeactivatedUserLoginException(string tenantCode)
        {
        ...
        public override string Message
        {
            get
            {
                return ExceptionConstant.USER_EXCEPTION_SECTION + "~" + ExceptionConstant.DEACTIVATED_USER_LOGIN;
            }
        }
