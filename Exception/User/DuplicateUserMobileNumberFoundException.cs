using System;
// <copyright file="DuplicateUserEmailAddressFoundException.cs" company="Websym Solutions Pvt. Ltd.">
...
namespace nIS
{
    ...
    /// </summary>
    public class DuplicateUserMobileNumberFoundException:Exception
    {
        ...
        public DuplicateUserMobileNumberFoundException(string tenantCode)
        {
