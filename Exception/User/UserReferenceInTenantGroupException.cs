// <copyright file="DuplicateUserFoundException.cs" company="Websym Solutions Pvt. Ltd.">
...
namespace nIS
{
    ...
    /// </summary>
    public class UserReferenceInTenantGroupException : Exception
    {
        ...
        public UserReferenceInTenantGroupException(string tenantCode)
        {
        ...
        public override string Message
        {
            get
            {
               return "User is used in tenant group primary user information";
            }
        }
