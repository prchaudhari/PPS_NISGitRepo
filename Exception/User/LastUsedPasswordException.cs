// <copyright file="LastUsedPasswordException.cs" company="Websym Solutions Pvt. Ltd.">
...
namespace nIS
{
    ...
    /// </summary>
    public class LastUsedPasswordException : Exception
    {
        ...
        public LastUsedPasswordException(string tenantCode)
        {
