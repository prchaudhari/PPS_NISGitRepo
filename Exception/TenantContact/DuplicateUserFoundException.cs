// <copyright file="DuplicateTenantContactFoundException.cs" company="Websym Solutions Pvt. Ltd.">
...
namespace nIS
{
    ...
    /// </summary>
    public class DuplicateTenantContactFoundException : Exception
    {
        ...
        public DuplicateTenantContactFoundException(string tenantCode)
        {
