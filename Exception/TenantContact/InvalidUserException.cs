// <copyright file="InvalidTenantContactException.cs" company="Websym Solutions Pvt. Ltd.">
...
namespace nIS
{
    ...
    /// </summary>
    public class InvalidTenantContactException : Exception
    {
        ...
        public InvalidTenantContactException(string tenantCode)
        {
