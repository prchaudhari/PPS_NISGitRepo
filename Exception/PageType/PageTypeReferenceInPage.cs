// <copyright file="PageTypeReferenceInUserException.cs" company="Websym Solutions Pvt. Ltd.">
...
namespace nIS
{
    ...
    /// </summary>
    public class PageTypeReferenceInTenantContactException : Exception
    {
        ...
        public PageTypeReferenceInTenantContactException(string tenantCode)
        {
