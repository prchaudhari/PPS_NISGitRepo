using System;
// <copyright file="DuplicateTenantUserEmailAddressFoundException.cs" company="Websym Solutions Pvt. Ltd.">
...
namespace nIS
{
    ...
    /// </summary>
    public class DuplicateTenantUserMobileNumberFoundException:Exception
    {
        ...
        public DuplicateTenantUserMobileNumberFoundException(string tenantCode)
        {
        ...
        public override string Message
        {
            get
            {
                return ExceptionConstant.DUPLICATE_USER_MOBILE_NO_FOUND_EXCEPTION;
            }
        }
