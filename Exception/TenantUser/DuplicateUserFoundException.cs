// <copyright file="DuplicateTenantUserFoundException.cs" company="Websym Solutions Pvt. Ltd.">
...
namespace nIS
{
    ...
    /// </summary>
    public class DuplicateTenantUserFoundException : Exception
    {
        ...
        public DuplicateTenantUserFoundException(string tenantCode)
        {
