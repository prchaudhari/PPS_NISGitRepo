// <copyright file="InvalidTenantUserException.cs" company="Websym Solutions Pvt. Ltd.">
...
namespace nIS
{
    ...
    /// </summary>
    public class InvalidTenantUserException : Exception
    {
        ...
        public InvalidTenantUserException(string tenantCode)
        {
