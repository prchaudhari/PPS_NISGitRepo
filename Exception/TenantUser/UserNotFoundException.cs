// <copyright file="TenantUserNotFoundException.cs" company="Websym Solutions Pvt. Ltd.">
...
namespace nIS
{
    ...
    /// </summary>
    public class TenantUserNotFoundException : Exception
    {
        ...
        public TenantUserNotFoundException(string tenantCode)
        {
