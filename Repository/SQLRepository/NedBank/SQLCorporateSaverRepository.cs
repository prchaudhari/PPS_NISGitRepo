                    ...
                    if (MCAMasterRecords != null && MCAMasterRecords.Count > 0)
                    {
                        MCAMasterRecords.ForEach(item =>
                        {
                            Records.Add(new DM_CorporateSaverMaster()
                            {
                                ...
                                AGENT_MESSAGE_AFRIKAANS = item.AgentMessageAfrikan,
                                AGENT_MESSAGE_ENGLISH = item.AgentMessageEnglish,
                                SECTION86_MESSAGE = item.Section86Message,
                                SHOWMESSAGE = item.ShowMessage,
                                MESSAGE_INDICATOR = item.MessageIndicator,
                                AGENT_NAME = item.AgentName,
                                AGENT_LOGO = item.AgentLogo,
                    ...
                    if (CorporateSaverTaxRecords != null && CorporateSaverTaxRecords.Count > 0)
                    {
                        CorporateSaverTaxRecords.ForEach(item =>
                        {
                            Records.Add(new DM_CorporateSaverTax()
                            {
                                ...
                                AGENT_FEE_STRUCTURE_2 = item.AgentFeeStructure2,
                                InterestMstr = item.InterestMaster1,
                                TotalCapitalMstr = item.TotalCapitalMaster,
                                TotalInterestMstr = item.TotalInterestMaster,
