                                ...
                                if (!widget.IsDynamicWidget)
                                {
                                    switch (widget.WidgetName)
                                    {
                                        ...
                                        case HtmlConstants.EARNINGS_FOR_PERIOD_WIDGET_NAME:
                                            this.BindEarningForPeriodWidgetData(pageContent, ErrorMessages, ppsDetails, page, widget);
                                            break;
        ...
        private bool BindProductSummaryWidgetData(StringBuilder pageContent, StringBuilder ErrorMessages, IList<spIAA_PaymentDetail> productSummary, Page page, PageWidget widget)
        {
            ...
            try
            {
               ...
               .FirstOrDefault().AE_Amount;
                    ...
                    var ppsPaymentR = (ppsPayment == 0) ? "R0.00" : Utility.FormatCurrency(ppsPayment.ToString("F2"));
                      ...
                      string intermediatryHeading= (String.IsNullOrEmpty(transactionitem.FirstOrDefault().INT_EXT_REF)) ? "Payment Details" : "Intermediary: " + transactionitem.FirstOrDefault().INT_EXT_REF + " " + transactionitem.FirstOrDefault().Int_Name; 
                        ...
                        transaction.Where(mwitem => (mwitem.INT_EXT_REF == transactionitem.FirstOrDefault().INT_EXT_REF)).GroupBy(gpDTTItem => new { gpDTTItem.INT_EXT_REF, gpDTTItem.Member_Ref }).ToList().ForEach(memberitem =>
                        {
                            ...
                            transaction.Where(witem => (witem.INT_EXT_REF == transactionitem.FirstOrDefault().INT_EXT_REF) && (witem.Member_Ref == memberitem.FirstOrDefault().Member_Ref)).OrderBy(item=>item.POSTED_DATE).ToList().ForEach(itemDTT =>
                          {
                              ...
                              detailedTransactionSrc.Append("<tr><td class='px-1 py-1 fsp-bdr-right fsp-bdr-bottom text-nowrap text-left'>" + itemDTT.Member_Name + "</td><td  class= 'fsp-bdr-right fsp-bdr-bottom px-1 text-nowrap text-left'>" + itemDTT.Member_Ref + "</td><td  class= 'fsp-bdr-right fsp-bdr-bottom px-1 text-nowrap text-left'> " + itemDTT.Policy_Ref + "</td><td class= 'text-left fsp-bdr-right fsp-bdr-bottom px-1 ewidth text-wrap text-break'><p style='inline-size:300px;overflow-wrap:break-word'>" + (itemDTT.Description == "Commission Service Fee" ? "Premium Under Advise Fee" : itemDTT.Description) + "</p></td><td class= 'text-left fsp-bdr-right fsp-bdr-bottom px-1 text-nowrap'>" + itemDTT.Commission_Type + "</td><td  class= 'text-left fsp-bdr-right fsp-bdr-bottom px-1 text-nowrap'>" + itemDTT.POSTED_DATE.ToString("dd-MMM-yyyy") + "</td><td  class= 'text-right fsp-bdr-right fsp-bdr-bottom px-1 text-nowrap ewidth'>" + Utility.FormatCurrency(displayItem) + "</td><td class= 'text-left fsp-bdr-bottom px-1'><a href ='https://www.google.com/' target ='_blank'><img class='leftarrowlogo' src='../common/images/leftarrowlogo.png' alt='Left Arrow'></a></td></tr>");
                            ...
                            detailedTransactionSrc.Append("<tr><td class='px-1 py-1 fsp-bdr-right fsp-bdr-bottom'></td><td class='fsp-bdr-right fsp-bdr-bottom px-1 py-1'></td><td class='fsp-bdr-right fsp-bdr-bottom px-1 py-1'></td><td class='text-right fsp-bdr-right fsp-bdr-bottom px-1 py-1'></td><td class='text-left fsp-bdr-right fsp-bdr-bottom px-1 py-1'><br/></td><td class='text-left fsp-bdr-right fsp-bdr-bottom px-1 py-1'></td><td class='text-right fsp-bdr-right fsp-bdr-bottom px-1 py-1 text-nowrap'>" + TotalPostedAmountRDT + "</td><td class='text-left fsp-bdr-bottom px-1'><a href='https://www.google.com/' target = '_blank' ><img src='../common/images/leftarrowlogo.png'></a></td></tr></table><div class='text-right py-3'></div></div>");
                        });
                    ...
                    records?.ForEach(transactionitem =>
                    {
                        ...
                        memberGroupRecords.ForEach(memberitem =>
                        {
                            ...
                            memberRecords.ForEach(memberitemrecord =>
                            {
                                ...
                                detailedTransactionSrc.Append("<tr><td class='bdr-right-white text-left text-nowrap'>" + memberitemrecord.Member_Name + "</td><td class='bdr-right-white text-left text-nowrap'>" + memberitemrecord.MEMBER_AGE + "</td>" + "<td class='bdr-right-white text-left text-nowrap'>" + memberitemrecord.MEMBER_REF + "</td>" +
      "<td class='bdr-right-white text-left text-nowrap'>" + memberitemrecord.POLICY_REF + "</td><td class='bdr-right-white text-left'>" + memberitemrecord.PRODUCT_DESCRIPTION + "</td><td class='bdr-right-white text-left text-nowrap'>" + memberitemrecord.REQUEST_DATETIME.ToString("dd-MMM-yyyy") + "</td><td class='bdr-right-white text-left text-nowrap'>" + memberitemrecord.REQUESTED_DATETIME.ToString("dd-MMM-yyyy") + "</td><td class='bdr-right-white text-left text-nowrap'>" + memberitemrecord.CommissionType + "</td><td class='bdr-right-white text-right text-nowrap'>" + (Utility.FormatCurrency((memberitemrecord.TRANSACTION_AMOUNT)) + "</td><td class='bdr-right-white text-right text-nowrap'>" + (memberitemrecord.AE_Posted_Date.ToString() == "1900-01-01 00:00:00.000" ? "" : memberitemrecord.AE_Posted_Date.ToString("dd-MMM-yyyy")) + "</td>" +
                            ...
                            detailedTransactionSrc.Append(" <tr><td class='dark-blue-bg text-white font-weight-bold '></td><td class='dark-blue-bg text-white font-weight-bold '></td><td class='dark-blue-bg text-white font-weight-bold '></td><td class='dark-blue-bg text-white font-weight-bold '></td><td class='dark-blue-bg text-white font-weight-bold '></td><td class='dark-blue-bg text-white font-weight-bold '></td><td class='dark-blue-bg text-white font-weight-bold '></td><td class='dark-blue-bg text-white font-weight-bold text-right' colspan='2'>Sub Total</td><td colspan='2' class='font-weight-bold text-right fs-16 pps-bg-gray' height='40'>" + Utility.FormatCurrency(TotalPostedAmountR) + "</td></tr>");
                        });
        ...
        //                gpCommisionType.ForEach(gpCommisionTypeitem =>
        //    {
        //        double premiumUnderAdviceTd1Sum = commisionDetail
        ...
        //        commisionDetailSrc.Append("<td class='text-right'>" + postedAmountTdSumR + "</td>");
                ...
                aePostedRecords.ForEach(gpMonthRangeItem =>
        {
                ...
                gpCommisionType.ForEach(gpCommisionTypeitem =>
            {
                ...
                // Calculating and appending HTML for Total Premium under advice
                double postedAmountTdSum = commisionDetail
                .Where(witem => witem.AE_Posted_Date.Date == gpMonthRangeItem.GroupKey.Date)
                .Sum(item => Convert.ToDouble(item.ALLOCATED_AMOUNT));
                ...
                prdocutDescriptionRecords.ForEach(prdocutDescription =>
        {
            ...
            if (sumOfAllocatedAmount != 0)
            {
                ...
                commisionDetailSrc.Append("<td class='text-right'>" + sumOfAllocatedAmountR + "</td>");
                FutureColumnSums += sumOfAllocatedAmount;
                sumOfDueDateAllocatedAmount += sumOfAllocatedAmount;
                commisionDetailSrc.Append("</tr>");
            }
        });
            ...
            // Group and aggregate Policy Data records
            var policyDataRecords = commisionDetail
                .Where(witem => witem.Type == "Policy_Data")
                .GroupBy(gpcommisionitem => new { gpcommisionitem.REQUEST_DATETIME.Month, gpcommisionitem.Type })
                .Select(group => new
                {
                    GroupKey = group.Key,
                    CountCommissionType = group.Count(),
            ...
            // Group and aggregate Fiduciary Data records
            var fiduciaryDataRecords = commisionDetail
                .Where(witem => witem.Type == "Fiduciary_Data")
                .GroupBy(gpcommisionitem => new { gpcommisionitem.REQUEST_DATETIME.Month, gpcommisionitem.Type })
                .Select(group => new
                {
                    GroupKey = group.Key,
            ...
            // Iterate through grouped records to populate table rows
            policyDataRecords.ForEach(gpMonthRangeItem =>
            {
            ...
            else
            {
                ...
                gpCommisionType.ForEach(gpCommisionTypeitem =>
                {
                    commisionDetailSrc.Append("<td class='text-right font-weight-bold'>R0.00</td>");
                });
            }
            commisionDetailSrc.Append("</tr></table></div></div>");
            ...
            // Iterate through grouped records to populate table rows for Fiduciary Fees
            fiduciaryDataRecords.ForEach(gpFeesMonthRangeItem =>
            {
