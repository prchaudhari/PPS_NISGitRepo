...
namespace nIS
{
  ...
  (Convert.ToDouble(memberitemrecord.TRANSACTION_AMOUNT) * -1).ToString() : "R" + Convert.ToDouble(memberitemrecord.TRANSACTION_AMOUNT)).ToString() + "</td><td class='bdr-right-white text-right'>" + (memberitemrecord.AE_Posted_Date.ToString() == "1900-01-01 00:00:00.000" ? "": memberitemrecord.AE_Posted_Date.ToString("dd-MMM-yyyy")) + "</td>" +
