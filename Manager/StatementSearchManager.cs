...
namespace nIS
{
    ...
    public class StatementSearchManager
    {
                            ...
                            for (int j = 0; j < pagewidgets.Count; j++)
                            {
                                ...
                                if (!widget.IsDynamicWidget)
                                {
                                    switch (widget.WidgetName)
                                    {
                                        ...
                                        //    this.BindEarningForPeriodWidgetData(pageContent, paymentSummary, page, widget);
                                            break;
        ...
        //            var IsHomeLoanPageTypePresent = statement.Pages.Where(it => it.PageTypeName == HtmlConstants.HOME_LOAN_FOR_OTHER_SEGMENT_ENG_PAGE_TYPE || it.PageTypeName == HtmlConstants.HOME_LOAN_FOR_OTHER_SEGMENT_AFR_PAGE_TYPE
        ...
        //                                            || it.PageTypeName == HtmlConstants.HOME_LOAN_FOR_WEA_SEGMENT_AFR_PAGE_TYPE || it.PageTypeName == HtmlConstants.HOME_LOAN_FOR_WEA_SEGMENT_ENG_PAGE_TYPE).ToList().Count > 0;
        ...
        private void BindEarningForPeriodWidgetData(StringBuilder pageContent, IList<spIAA_Commission_Detail> commisionDetail, Page page, PageWidget widget)
        {
            if (commisionDetail != null && commisionDetail.Count > 0)
            {
        ...
        //            {
        //                InvestmentAccountDetailHtml.Replace("{{InterestDue}}", utility.CurrencyFormatting(ModelConstant.SA_COUNTRY_CULTURE_INFO_CODE, ModelConstant.DOT_AS_CURERNCY_DECIMAL_SEPARATOR, ModelConstant.CURRENCY_FORMAT_VALUE, res));
        //            }
        //            else
        //            {
        //                InvestmentAccountDetailHtml.Replace("{{InterestDue}}", string.Empty);
        //            }
