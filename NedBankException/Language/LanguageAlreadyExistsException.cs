...
namespace NedBankException
{
    ...
    public class LanguageAlreadyExistsException : Exception
    {
        ...
        public LanguageAlreadyExistsException(string tenantCode)
        {
        ...
        public override string Message
        {
            get
            {
                return ExceptionConstant.COMMON_EXCEPTION_SECTION + "~" + ExceptionConstant.LANGUAGE_ALREADY_EXISTS_EXCEPTION;
            }
        }
